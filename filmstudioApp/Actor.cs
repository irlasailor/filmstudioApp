...
namespace filmstudioApp
{
    public partial class Actor : Form
    {
        ...
        private void button3_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                try
                {
                    ...
                    string currentId = "";
                    //int currentIdNum = -1;
                    cmd.CommandText = $"SELECT IdAuth FROM authentification WHERE(dbo.authentification.login  = '{textBox2.Text}' AND dbo.authentification.password = HASHBYTES('SHA2_256', '{textBox3.Text}') AND EXISTS(SELECT * from Actors, authentification WHERE Actors.authId = authentification.IdAuth AND authentification.login = '{ textBox2.Text}'))";
        ...
        private void authentificationDataGridView_CellContentClick(object sender, DataGridViewCellEventArgs e)
        {
